...
export default function Services() {
  ...
  ); // Slide-in panel component (unchanged)
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="w-full h-48 md:h-64 bg-gray-100 rounded-md overflow-hidden mb-4">
                ...
                <img
                  // Prepend the base URL here
                  src={`${IMAGE_BASE_URL}${service.imageUrl || service.image}`}
                  alt={service.title}
                  className="w-full h-full object-cover"
                />
                             {" "}
              ...
              {/* Display features from the service object if available */}
        ...
        <section className="py-12 px-4 bg-gray-50">
          ...
          {isLoading ? (
            ...
            <div
              ...
              style={{ scrollBehavior: "auto" }}
            >
              {/* FIX: Map over hotelServices and use 'image' property. Removed duplication for clarity. */}
              {hotelServices &&
                hotelServices.map((h, idx) => (
                  <ServiceCard
                    ...
                    title={h.title}
                    subtitle={h.subtitle}
                    imageUrl={h.image} // Assuming hotel API also uses 'image'
                    tag={"Hotel"}
                    onClick={() => openPanel(h)}
                  />
                ))}
